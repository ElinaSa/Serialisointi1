...
namespace Serialisointi1
{
    ...
    {
        // Fields with lower case 1st letter, these are private by no scope definition
        string firstName;
        string lastName;
        string dateOfBirth;
        int startYear;
    ...
    internal class Program
    {
        static void Main()
        {
            ...
            students[0] = new Student("Jaana", "Esimerkki", "1997-11-20", 2023, "IT-tukihenkilö");
            students[1] = new Student("Miina", "Jyrkkälä", "1979-07-16", 2022, "Ohjelmistokehittäjä");
            students[2] = new Student("Mikko", "Mannila", "1982-11-20", 2022, "Ohjelmistokehittäjä");
